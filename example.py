if __name__ == '__main__':
	import fileForker
	trackerChild = fileForker.childClass(childFile='pytracker/trackerProcess')
	...
	trackerChild.initDict['faceDetectionScale'] = 10
	trackerChild.initDict['eyeDetectionScale'] = 5
	...
	trackerChild.initDict['saccadeAlertSizeInDegrees'] = 1
	trackerChild.start()
	import time
